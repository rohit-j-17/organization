...
$qry = "INSERT INTO `users` (`id`,`firstname`,`lastname`,`name`,`parent`,`user_type`,`company_name`,`address`,`joining_date`,`dob`,`qualification`,`mobile`,`year_of_experience`,`department`,`current_ctc`,`previous_ctc`,`previous_department`,`previous_location`,`date_of_last_increament`) 
VALUES 
