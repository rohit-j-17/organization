    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(typeof data.name !== 'undefined'){
                nameString = '<p>'+'Employee Position :'+'&nbsp;'+self.data.name+'</p>';
            }
            if(typeof data.description !== 'undefined'){
                descString = '<p>'+self.data.description+'</p>';
            }
              if(typeof data.firstname !== 'undefined'){
                firstnameString = '<p>'+'Employee Name :'+'&nbsp;'+self.data.firstname+'&nbsp;'+self.data.lastname+'</p>';
            }
              if(typeof data.lastname !== 'undefined'){
                lastnameString = '<p>'+self.data.lastname+'</p>';
            }
             if(typeof data.company_name !== 'undefined'){
                companynameString = '<p>'+'Company :'+'&nbsp;'+self.data.company_name+'</p>';
            }
             if(typeof data.other_to_reporting !== 'undefined'){
                othernameString = '<p>'+'Additional Report :'+'&nbsp;'+self.data.other_to_reporting+'</p>';
            }
            if(typeof data.image !== 'undefined'){
                imagenamestring = '<img src='+self.data.image+' height="50px" width="50px" class="img-circle" />';
            }
            ...
            return "<div style='margin-left:20px;' class='node' node-id='"+this.data.id+"'>"+imagenamestring+firstnameString+nameString+companynameString+othernameString+buttonsHtml+"</div>";
        }
    }
